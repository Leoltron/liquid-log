...
<%@ page import="ru.naumen.sd40.log.parser.implementations.pagerender.data.PageRenderDataType" %>
...
<%
    Number[] p50 = (Number[]) request.getAttribute(PageRenderDataType.PERCENTILE50);
    Number[] p95 = (Number[]) request.getAttribute(PageRenderDataType.PERCENTILE95);
    Number[] p99 = (Number[]) request.getAttribute(PageRenderDataType.PERCENTILE99);
    Number[] p999 = (Number[]) request.getAttribute(PageRenderDataType.PERCENTILE999);
    Number[] p100 = (Number[]) request.getAttribute(PageRenderDataType.MAX);
    Number[] count = (Number[]) request.getAttribute(PageRenderDataType.COUNT);
    Number[] mean = (Number[]) request.getAttribute(PageRenderDataType.MEAN);
    Number[] stddev = (Number[]) request.getAttribute(PageRenderDataType.STDDEV);
...
<div class="container">
    ...
    <ul class="nav nav-pills">
        <% for(IDataType type: dataTypes) {
         if(type instanceof PageRenderDataType) {%>
